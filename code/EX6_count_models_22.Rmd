...
![Macro Level Proposition](C:/Users/ozd504/Github/dem-stats-book/images/macro2.png)
...
im_dat <- readr::read_csv("C:/Users/ozd504/Github/dem-stats-book/data/nhgis0025_ds231_2005_county.csv")
...
```{r}
library(gt)
txca <- readr::read_delim(url("https://raw.githubusercontent.com/coreysparks/dem-stats-book/master/data/CMF_TX_CA_age.txt?token=GHSAT0AAAAAABQZ5VMKYNG6BLT3ZTZEQJDCYRP2ZGA"),
                          delim = "\t",
                          quote = "\"",
                          skip=1,
                          col_names = c("State",
