...
X<- data.frame(lapply(brfss_17b[1:1000, c(3,4,5,8,10,11,12,13,14,15,16)], as.factor))
...
brfss.pc<-PCA(brfss_17b[1:10000, c(8,10,11,12,13,14,15,16)],scale.unit = T, graph = F)
